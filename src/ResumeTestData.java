...
public class ResumeTestData {
    ...
    public static void main(String[] args) {
        ...
        AbstractSection listSection1 = new ListSection(Arrays.asList("Организация команды и успешная реализация Java проектов для сторонних заказчиков: приложения автопарк на стеке Spring Cloud/микросервисы, система мониторинга показателей спортсменов на Spring Boot, участие в проекте МЭШ на Play-2, многомодульный Spring Boot + Vaadin проект для комплексных DIY смет",
        ...
        Company company = new Company("www.Alcatel.com", "Alcatel", periodList);
        ...
        Company company2 = new Company("https://javaops.ru/", "Java Online Projects", periodList2);

        //Заполняем CompanySection
        CompanySection companySection = new CompanySection(List.of(company, company2));
